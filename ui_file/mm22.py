...
# Form implementation generated from reading ui file 'make_mail22.ui'
#
...
"font: 14pt \"MS Shell Dlg 2\";")
        ...
        self.list_of_attaches = QtWidgets.QComboBox(Dialog)
        self.list_of_attaches.setGeometry(QtCore.QRect(200, 420, 191, 41))
        self.list_of_attaches.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.list_of_attaches.setObjectName("list_of_attaches")
        self.list_of_attaches.addItem("")
        self.list_of_attaches.addItem("")
        self.list_of_attaches.setItemText(0, _translate("Dialog", "файл1"))
        self.list_of_attaches.setItemText(1, _translate("Dialog", "файл2"))
        ...
        self.attach_2 = QtWidgets.QPushButton(Dialog)
        self.attach_2.setGeometry(QtCore.QRect(440, 420, 41, 41))
        self.attach_2.setStyleSheet("font: 14pt \"MS Shell Dlg 2\";\n"
"background-color: rgb(255, 255, 255);")
        self.attach_2.setObjectName("attach_2")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.attach_2.setText(_translate("Dialog", "🔙"))
